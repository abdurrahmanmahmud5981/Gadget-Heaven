...
const Navber = () => {
  const [showCartsNumbers, setShowCartsNumbers] = useState(0);
  const [showWishListNumbers, setshowWishListNumbers] = useState(0);

  useEffect(() => {
    const num = getAllCarts().length
    setShowCartsNumbers(num);
